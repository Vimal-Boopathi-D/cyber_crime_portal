...
public class DocumentServiceImpl implements DocumentService {
    ...
    public byte[] generateComplaintReport(Long complaintId) {
        ...
        try {
            ...
            addRow(incidentTable, "Category", complaint.getCategory());
    ...
    public byte[] getFIRCopy(Long complaintId) {
        // Mock FIR retrieval
        FIR fir = firRepository.findById(complaintId)
        ...
        try {
            ...
            addRow(headerTable, "Generated By", fir.getGeneratedBy());
...
//                                ? c.getAssignedOfficer().getPoliceStation()
//                                : "NA";
...
//                row.createCell(5).setCellValue(policeStation);
